								...
								<View style={styles.modalContainer}>
									...
									{currentPage === 'initial' ? (
										...
										<>
											...
											<Text style={styles.modalText}>
												Choose a goal that fits you best:
											</Text>
											<TouchableOpacity
												style={[
													styles.modalButton,
											...
											{selectedGoal && selectedGoal !== 'advanced' && (
												<View style={styles.dropdownContainer}>
													<Text style={styles.dropdownText}>
														{selectedGoal === 'loseWeight' &&
															'You will receive menu options with a lower calorie count.'}
														{selectedGoal === 'buildMuscle' &&
															'You will receive menu options with a higher protein and carb count.'}
														{selectedGoal === 'maintenance' &&
															'You will receive balanced menu options.'}
													</Text>
												</View>
											)}
											<TouchableOpacity
										...
										<>
											<Text style={styles.modalTitle}>
												Set Nutrient Goals for {selectedGoal}
											</Text>
											<TextInput
												style={styles.input}
